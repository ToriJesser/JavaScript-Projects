// creates an pbject to keep track of values
const Calculator = {
    // this displays 0 on the screen
    Display_Value: '0',
    // this  will hold the first operand for any expressions, we set it ot null for now
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    // we are checking to see if Wait_Second_Operand is true an set
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        // we are saying that if the Display_Value does not contaun a decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    // displayed on hte screen to a number and then store the resukt in
